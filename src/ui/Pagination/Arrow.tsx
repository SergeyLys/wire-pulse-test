...
const Arrow: React.FC<ArrowProps> = ({direction, handlePageClick}) => {
  return direction === 'left' ? (
    <div data-testid="pagination-arrow-prev" className="prev arrow" onClick={handlePageClick}>
    ...
    <div data-testid="pagination-arrow-next" className="next arrow" onClick={handlePageClick}>
      <svg height="800px" width="800px" version="1.1" xmlns="http://www.w3.org/2000/svg" 
